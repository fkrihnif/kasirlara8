...
<div class="row">
    ...
    <div class="col-4">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('kasir.transaction-new.pay') }}" method="post">
                    @csrf
                    <label>
  ...
  <script>
    ...
    $(document).ready(function(){
        ...
        function fetchstudent() {
            $.ajax({
                type: "GET",
                url: '{{ route('kasir.transaction-new.indexs') }}',
                dataType: "json",
        ...
        function tambahkan() {
            ...
            if ($productCode.val() != ''){
                $.ajax({
                    ...
                    url: '{{ route('kasir.transaction-new.addToCart') }}',
        ...
        function editLastProduct() {
            let id = '1';
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {'id':id},
                    url: '{{ route('kasir.transaction-new.showLastProduct') }}',
                    success:function(response){
        ...
        function deleteLastProduct() {
            let id = '1';
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {'id':id},
                    url: '{{ route('kasir.transaction-new.deleteLastProduct') }}',
                    success: function(data){
                        fetchstudent();
                        getTotalBuy();
                        fetchstudent();
        ...
        function deleteAllCart() {
            let id = '1';
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {'id':id},
                    url: '{{ route('kasir.transaction-new.deleteAllCart') }}',
                    success: function(data){
                        fetchstudent();
                        getTotalBuy();
                        fetchstudent();
        ...
        customer_container.addEventListener('click', function(e) {
            if(e.target.classList.contains('delete-btn')){
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {'id':id},
                    url: '{{ route('kasir.transaction-new.deleteCart') }}',
                });
                fetchstudent();
                getTotalBuy();
                fetchstudent();
                ...
                $.ajax({
                    ...
                    dataType: 'json',
                    data: {'id':id},
                    url: '{{ route('kasir.transaction-new.show') }}',
                    success:function(response){
        ...
        updateQuantity.addEventListener('click', function() {
            ...
            $.ajax({
                ...
                url: `/kasir/transaction-new/update/${productTransaction_id}`,
                type: "PUT",
                cache: false,
                data: {
                    "quantity": quantity,
        ...
        function getTotalBuy(){
            $.ajax({
                type: 'GET',
                url: '{{ route('kasir.transaction-new.totalBuy') }}',
                dataType: 'json',
                success: function(data){
